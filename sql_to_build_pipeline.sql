...
CREATE or REPLACE TABLE INSURANCE.ML_PIPE.SOURCE_OF_TRUTH (
	...
	BMI FLOAT,
	CHARGES FLOAT, -- our predictive variable
...
CREATE or REPLACE TABLE INSURANCE.ML_PIPE.INCOMING_DATA_SOURCE (
	...
	GENDER VARCHAR(16777216),
	BMI FLOAT,
	CHARGES FLOAT, -- predictive variable
	CHILDREN NUMBER(38,0),
	SMOKER VARCHAR(16777216),
	REGION VARCHAR(16777216),
	MEDICAL_HISTORY VARCHAR(16777216),
...
LIMIT 100000; -- Change this number to test prediction speed at different quantities

-- View the inserted records in the landing table
SELECT count(*) FROM LANDING_TABLE limit 100;
...
SELECT count(*) FROM INSURANCE_GOLD;
